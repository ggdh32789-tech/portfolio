...
const translations = {
    ...
    'code.c1.title':{ zh: '藏历小助手',     en: 'Tibetan Calendar' },
    'code.c1.desc': { zh: '输入公历日期，查看对应的藏历日期。一个简单的小工具。', en: 'Enter a date to see its Tibetan calendar equivalent. A simple little tool.' },
    'code.c2.title':{ zh: '像素经幡生成器', en: 'Pixel Prayer Flags' },
